...
@Repository
class ArtistGenreRepositoryCustomImpl(
    private val databaseClient: DatabaseClient
) : ArtistGenreRepositoryCustom {

    override fun insertBatch(artistGenres: Collection<ArtistGenre>): Flux<ArtistGenre> {
    ...
    override fun selectBatch(artistIdGenres: Set<Pair<String, List<String>>>): Flux<ArtistGenre> {
