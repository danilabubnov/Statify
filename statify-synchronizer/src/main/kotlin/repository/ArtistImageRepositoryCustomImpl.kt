...
@Repository
class ArtistImageRepositoryCustomImpl(
    private val databaseClient: DatabaseClient
) : ArtistImageRepositoryCustom {

    override fun insertBatch(artistImages: Collection<ArtistImage>): Flux<ArtistImage> {
    ...
    override fun selectBatch(artistIdImages: Set<Pair<String, List<String>>>): Flux<ArtistImage> {
