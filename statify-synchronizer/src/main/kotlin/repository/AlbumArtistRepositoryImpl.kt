...
class AlbumArtistRepositoryImpl(
    ...
    override fun insert(albumArtist: AlbumArtist): Mono<AlbumArtist> {
        return databaseClient
            ...
            .bind("albumId", albumArtist.albumId)
            .bind("artistId", albumArtist.artistId)
            .fetch()
            .rowsUpdated()
            .thenReturn(albumArtist)
    }

    override fun findByAlbumArtistPairs(pairs: Set<Pair<String, String>>): Flux<AlbumArtist> {
    ...
    override fun insertBatch(albumArtists: Collection<AlbumArtist>): Flux<AlbumArtist> {
